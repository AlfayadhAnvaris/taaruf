    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', minHeight: '60vh', background: 'white', animation: 'fadeIn 0.5s ease', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center', padding: '1.5rem' }}>
          <div style={{ width: '80px', height: '80px', background: 'rgba(19,78,57,0.05)', color: '#134E39', borderRadius: '28px', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 1.5rem', boxShadow: '0 10px 25px rgba(0,0,0,0.02)' }}>
          ...
          <button 
            ...
            style={{ background: '#134E39', color: 'white', border: 'none', padding: '0.8rem 2rem', borderRadius: '12px', fontWeight: '800', cursor: 'pointer', fontSize: '0.9rem' }}
          >
            KEMBALI
          </button>
        </div>
    ...
    <div style={{ 
      ...
      <form onSubmit={handleSubmit} style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '2rem' }}>
          ...
          {/* CATEGORY SECTION */}
          <div style={{ background: '#F8FAF9', padding: '1.75rem', borderRadius: '24px', border: '1px solid #F1F5F9' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '1.5rem' }}>
              <div style={{ width: '32px', height: '32px', borderRadius: '10px', background: '#134E39', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          {/* RATING SECTION */}
          <div style={{ background: '#FFFCF5', padding: '1.75rem', borderRadius: '24px', border: '1px solid #FFF1CC', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '1.75rem' }}>
              <div style={{ width: '32px', height: '32px', borderRadius: '10px', background: '#D4AF37', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <Star size={16} fill="white" />
              </div>
              <h3 style={{ margin: 0, fontSize: '0.9rem', fontWeight: '900', color: '#134E39', letterSpacing: '0.02em' }}>TINGKAT KEPUASAN</h3>
            </div>

            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: 'white', padding: '1.25rem', borderRadius: '18px', border: '1px solid #FFF1CC' }}>
        ...
        <div style={{ position: 'relative' }}>
          <div style={{ background: '#F8FAFC', padding: '2rem', borderRadius: '32px', border: '1px solid #E2E8F0' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '1.5rem' }}>
              <div style={{ width: '32px', height: '32px', borderRadius: '10px', background: '#134E39', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <Send size={14} />
              </div>
            ...
            <textarea 
              ...
              style={{ 
                width: '100%', minHeight: '160px', padding: '1.25rem', borderRadius: '20px', 
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '1.5rem' }}>
              <button 
                ...
                style={{ 
                  ...
                  padding: '1rem 3rem', borderRadius: '14px', fontWeight: '950', fontSize: '1rem',
