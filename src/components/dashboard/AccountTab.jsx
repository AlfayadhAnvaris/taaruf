...
const Field = ({ label, value, icon }) => (
  <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem', padding: '1rem 0', borderBottom: '1px solid #F1F5F9' }}>
    <div style={{ width: 40, height: 40, borderRadius: '12px', background: 'rgba(19,78,57,0.05)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#134E39', flexShrink: 0 }}>
      {icon}
    </div>
    <div style={{ flex: 1 }}>
...
const InputField = ({ label, fieldKey, type = 'text', placeholder, value, onChange }) => (
  <div style={{ marginBottom: '1.25rem' }}>
    ...
    <input 
      ...
      style={{ width: '100%', padding: '1rem 1.25rem', borderRadius: '14px', border: '1px solid #E4EDE8', fontSize: '1rem', outline: 'none', transition: 'border-color 0.2s', color: '#1C2B22' }}
  ...
  const ReligiousCard = ({ label, value, icon }) => {
    ...
    return (
      <div 
        ...
        style={{ 
          background: 'white', border: '1px solid #E4EDE8', borderRadius: '28px', padding: '1.75rem',
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '1rem' }}>
          <div style={{ width: 36, height: 36, borderRadius: '10px', background: 'rgba(19,78,57,0.05)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#134E39' }}>{icon}</div>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', background: '#f8fafc', animation: 'fadeIn 0.5s ease' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '2rem' }}>
            ...
            {!isEditing && (
              <button 
                ...
                style={{ background: '#D4AF37', color: '#134E39', border: 'none', padding: '1rem 2rem', borderRadius: '16px', fontWeight: '800', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px', boxShadow: '0 10px 20px rgba(0,0,0,0.1)' }}
              >
      ...
      <div style={{ padding: '4rem 5%', flex: 1 }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          {!isProfileComplete && (
            <div style={{ background: '#FFF7ED', border: '1px solid #FFEDD5', borderRadius: '32px', padding: '2rem', marginBottom: '3rem', display: 'flex', alignItems: 'center', gap: '1.5rem', boxShadow: '0 10px 25px rgba(251,146,60,0.08)' }}>
              <div style={{ width: 60, height: 60, background: '#F97316', color: 'white', borderRadius: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
          ...
          {!isEditing ? (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4rem' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '4rem' }}>
                <div>
                  ...
                  <div style={{ background: 'white', padding: '1rem 2rem', borderRadius: '32px', border: '1px solid #E4EDE8' }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '1.5rem', alignItems: 'flex-start', marginTop: '1.5rem' }}>
                ...
                <button 
                  ...
                  style={{ background: 'transparent', color: '#EF4444', border: '2px solid #EF4444', padding: '1rem', width: '240px', borderRadius: '18px', fontWeight: '900', cursor: 'pointer', transition: 'all 0.2s', fontSize: '0.9rem', textAlign: 'center' }}
            ...
            /* 📝 EDIT FORM 📝 */
            <div style={{ background: '#f8fafc', padding: '4rem', borderRadius: '40px', border: '1px solid #E4EDE8', boxShadow: '0 20px 50px rgba(0,0,0,0.02)' }}>
               <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '3rem', borderBottom: '1px solid #F1F5F9', paddingBottom: '2rem' }}>
                 ...
                 <div style={{ display: 'flex', gap: '1rem' }}>
                    <button onClick={() => {
                      ...
                      setIsEditing(false);
                    }} style={{ background: '#F1F5F9', color: '#64748B', border: 'none', padding: '0.8rem 2rem', borderRadius: '14px', fontWeight: '800', cursor: 'pointer' }}>BATAL</button>
                    <button onClick={handleSave} disabled={isSaving} style={{ background: '#134E39', color: 'white', border: 'none', padding: '0.8rem 2rem', borderRadius: '14px', fontWeight: '800', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px' }}>
               ...
               <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '4rem' }}>
                 <div>
                    ...
                    <div style={{ marginBottom: '1.25rem' }}>
                      ...
                      <select value={form.pendidikan_terakhir} onChange={e => set('pendidikan_terakhir', e.target.value)} style={{ width: '100%', padding: '1rem 1.25rem', borderRadius: '14px', border: '1px solid #E4EDE8', fontSize: '1rem', outline: 'none', color: '#1C2B22' }}>
                    ...
                    <div style={{ marginBottom: '1.25rem' }}>
                      ...
                      <select value={form.domisili_provinsi} onChange={e => { set('domisili_provinsi', e.target.value); set('domisili_kota', ''); }} style={{ width: '100%', padding: '1rem 1.25rem', borderRadius: '14px', border: '1px solid #E4EDE8', fontSize: '1rem', outline: 'none' }}>
                    ...
                    <div style={{ marginBottom: '1.25rem' }}>
                      ...
                      <select value={form.domisili_kota} onChange={e => set('domisili_kota', e.target.value)} disabled={!form.domisili_provinsi || isFetchingCities} style={{ width: '100%', padding: '1rem 1.25rem', borderRadius: '14px', border: '1px solid #E4EDE8', fontSize: '1rem', outline: 'none' }}>
                    ...
                    {isAkhwat && (
                      <div style={{ marginTop: '3rem', background: '#FFF7ED', padding: '2rem', borderRadius: '24px', border: '1px solid #FFEDD5' }}>
                        ...
                        <div style={{ marginBottom: '1rem' }}>
                          ...
                          <textarea value={form.polygamy_view} onChange={e => set('polygamy_view', e.target.value)} style={{ width: '100%', minHeight: '80px', padding: '1rem', borderRadius: '14px', border: '1px solid #E4EDE8', outline: 'none' }} placeholder="Tuliskan pandangan Anda..." />
                        </div>
                      </div>
                    )}
                 </div>
                 ...
                 <div>
                    ...
                    {[
                      ...
                      <div key={f.key} style={{ marginBottom: '1.5rem' }}>
                        ...
                        <textarea value={form[f.key]} onChange={e => set(f.key, e.target.value)} style={{ width: '100%', minHeight: '120px', padding: '1rem 1.25rem', borderRadius: '16px', border: '1px solid #E4EDE8', fontSize: '1rem', outline: 'none', lineHeight: 1.6 }} placeholder="Jelaskan secara detail..." />
                      </div>
                    ))}
                 </div>
               </div>
      ...
      {activeDetail && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(19,78,57,0.5)', backdropFilter: 'blur(10px)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 10001, padding: '2rem' }} onClick={() => setActiveDetail(null)}>
           <div style={{ background: 'white', width: '100%', maxWidth: '600px', borderRadius: '35px', padding: '2.5rem', position: 'relative', animation: 'scaleUp 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275)' }} onClick={e => e.stopPropagation()}>
              <button onClick={() => setActiveDetail(null)} style={{ position: 'absolute', top: '1.5rem', right: '1.5rem', background: '#F1F5F9', border: 'none', width: '40px', height: '40px', borderRadius: '12px', cursor: 'pointer' }}><XIcon size={20} /></button>
              <div style={{ display: 'flex', alignItems: 'center', gap: '15px', marginBottom: '2rem' }}>
                 <div style={{ width: 54, height: 54, borderRadius: '16px', background: 'rgba(19,78,57,0.05)', color: '#134E39', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>{activeDetail.icon}</div>
                 <h3 style={{ margin: 0, fontSize: '1.3rem', fontWeight: '900', color: '#134E39' }}>{activeDetail.title}</h3>
              </div>
              <div style={{ background: '#F8FAF9', padding: '1.5rem', borderRadius: '24px', border: '1px solid #E4EDE8', fontSize: '1.05rem', lineHeight: 1.8, color: '#475569', whiteSpace: 'pre-wrap' }}>
                {activeDetail.value}
              </div>
           </div>
        </div>
